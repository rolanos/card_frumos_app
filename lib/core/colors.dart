...
abstract class ColorsUI {
  ...
  static Color mainGrey = const Color.fromRGBO(65, 65, 65, 1);
  static Color mainTextGrey = const Color.fromRGBO(113, 113, 113, 1);
  static Color secondaryTextGrey = const Color.fromRGBO(158, 158, 158, 1);
  ...
  static Color mainTextRed = const Color.fromRGBO(255, 112, 116, 1);
}
